...
<br>
<strong>Komentar:</strong>
Zamaknjena porazdelitev, oziroma različni pričakovani vrednosti markerjev ne spremenita lastnosti testov, kjub temu, da je zaradi kombinacije predpostavk v tem primeru AUC vrednost drugega markerja lahko bolj primerljiva z AUC vrednostjo prvega markerja. Izkazalo se je, da v kolikor v testih ne bi uporabili rangiranja in s tem na nek način standardiziranja spremenljivk, bi bile tako velikosti, kot moči testa v primeru zamaknjene porazdelitve veliko slabše.
</div>
</div>
...
<br>
Če želimo preveriti kako vpliva odvisnost markerjev, moramo preveriti, kakšne rezultate dobimo pri različnih korelacijskih faktorjih med markerjema. V tem primeru bomo pogledali rezultate za nekorelirana markerja. 
...
<br>
Če želimo preveriti kako vpliva odvisnost markerjev, moramo preveriti, kakšne rezultate dobimo pri različnih korelacijskih faktorjih med markerjema. V tem primeru bomo pogledali rezultate za močno koreliranima markerja. 
...
<br>
<strong>Komentar:</strong>
Vrednosti AUC sta si v našem primeru nekoliko bolj različni, vendar zelo podobni. Moč testa je zato zelo majhna, kar smo lahko tudi pričakovali. 
</div>
</div>
...
<br>
Želimo preveriti, kako se obnesejo permutacijski testi v primeru zelo majhnega vzorca podatkov, zato v tem primeru generiramo manjši začetni vzorec, ostale predpostavke pa pustimo takšne, kot so bile v prvotnem primeru.
...
<br>
<strong>Komentar:</strong>
Kadar imamo tako majhen vzorec, testi niso več zanesljivi. Težaven je že izračun ROC krivulje in posledično vrednosti AUC.
</div>
</div>
***
### Gamma porazdelitev
...
<br>
Poglejmo še primer, ko markerja nista generirana iz normalne porazdelitve. V tem primeru naj bosta oba oba generirana iz $\Gamma(2,2)$ ter medsebojno korelirana z $\rho=0.5$.
...
<br>
<strong>Komentar:</strong>
V primeru drugačne porazdelitve, kot normalne, so testi še vedno zelo zanesljivi. Nekoliko manjšo moč imata Test 2 in Test 4, torej testa, kjer permutiramo po stolpcu z boleznimi. Kot smo že omenili, tak test ni pravilen, saj ne uniči le razlike med markerjema, vednar celoten vpliv markerjev. 
</div>
</div>
***
...
<br>
Poglejmo si še primer, ko markerja generiramo markerja iz diskretne porazdelitve. Naj bo $X_1 \sim Pois(2)$, $X_2 \sim Pois(2)$ in $\rho=0.5$.
...
<br>
<strong>Komentar:</strong>
Tudi v primeru diskretne porazdelitve se Test 1 in Test 2 izkažeta za zanesljivega. Moč testa je visoka, primerni pa sta tudi velikosti testov.
</div>
</div>
***
...
<br>
<strong>Komentar:</strong>
V našem primeru različnih porazdelitev sta ROC krivulji močno različni ena od druge. vrednot AUC prvega markerja je tako zelo visoka, vrednost AUC drugega markerja pa zelo nizka. Zato smo dobili tudi tako visoke moči testov. Dobili pa smo tudi zelo majhne velikosti, kar pomeni, da v primeru enakih vplivov test zelo redko zavrne ničelno hipotezo. 
</div>
</div>
...
Na našem praktičnem primeru smo preiskusili definirane teste na podaktih, ki so bili generirani tako, da je en marker boljši od drugega, sta pa korelirana. V tem prvotnem primeru sta bila markerja enako, normalno porazdeljena. Pri prvih treh testih, smo ničeno hipotezo, da sta markerja enakovredna, pri stopnji značilnosti 0.05 zavrnili in sklepali, da imata markerja statistično značilno razliko AUC vrednosti. Ničelne hipoteze pa pri stopnji značilnosti 0.05 ali manj nismo uspeli zavrniti pri četrtem testu. 

Pri pregledovanju lastnosti smo si pogledali 10 različnih scenarijev. Zanimalo nas je kako stabilen je test, če spreminjamo porazdelitve, korelacijo markerjev in pa velikost vzorca. 
...
Moči testa so bile manjše v primeru majhnega vzorca, v tem primeru pa smo opazili tudi, da imamo težave že z generiranjem ROC krivulj in izračunom AUC. 

Testi so imeli zelo majhno moč tudi v primeru skoraj enakega vpliva markerjev, kar je pričakovano, saj to pomeni da noben od markerjev ni izrazito boljši od drugega in rezultati bi bili podobni, ne glede na to katerega bi izbrali. Pri podobnem vplivu se je moč rahlo, vendar še vedno zelo malo dvignila v primeru, ko sta bila markerja neodvisna. 

Nekoliko manjša moč testov je bila tudi, ko smo imeli močno korelirana markerja. Videli smo, da smo v tem primeru dobili zelo visoki AUC vrednosti obeh markerjev, ki pa sta si bili zelo podobni. 

Testi pa torej dobro delujejo na zmerno koreliranih podatkih, ne-normalno ali celo diskretno porazdeljenih markerjih in pa tudi v primeru različnih porazdelitev markerjev. Ne smemo pa seveda pozabiti na uporabo rangov, saj so le-te ključni za dobre rezultate v primeru različnih porazdelitev.  

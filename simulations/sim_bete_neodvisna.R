...
##----------------------------------------------------------------
##                  NORMALNA - beta, neodvisna                 --
##----------------------------------------------------------------



## TESTI ZA NORMALNE PODATKE
mu1<-0; mu2<-0; ro<-0; b1<-6; b2<-5
...
##----------------------------------------------------------------
##            Velikost testa NORMAL-beta, neodvisna             --
##----------------------------------------------------------------
...
velikosti.bete.neodvisna <- data.frame("Velikost" = c(vel1,vel2,vel3,vel4),
                        row.names = paste0("Test ",1:4))

##---------------------------------------------------------------
##             Moč testa  NORMAL - beta, neodvisna             --
##---------------------------------------------------------------
...
moci.bete.neodvisna <- data.frame("Moc testa" = c(moc1,moc2,moc3,moc4),
                   row.names = paste0("Test ",1:4))


dump(c("podatki","test1","test2","test3","test4",
       "velikosti.bete.neodvisna","moci.bete.neodvisna"), "rezultati_bete_neodvisna.R")

...
mu1<-0; mu2<-0; ro<-0.9; b1<-6; b2<-2

podatki <- get.data(n, mu1, mu2, ro, b1, b2)

test1.kor09 <- testiraj(podatki, perm.cols=c("X1","X2"), m.type="razlika", n=N)
test2.kor09 <- testiraj(podatki, perm.cols=c("y"), m.type="razlika", n=N)
test3.kor09 <- testiraj(podatki, perm.cols=c("X1","X2"), m.type="razmerje", n=N)
test4.kor09 <- testiraj(podatki, perm.cols=c("y"), m.type="razmerje", n=N)
...
velikosti.kor09 <- data.frame("Velikost" = c(vel1,vel2,vel3,vel4),
...
moci.kor09 <- data.frame("Moc testa" = c(moc1,moc2,moc3,moc4),
                        row.names = paste0("Test ",1:4))


dump(c("podatki","test1.kor09","test2.kor09","test3.kor09","test4.kor09",
       "velikosti.kor09","moci.kor09"), "rezultati_kor0.9.R")

...
##----------------------------------------------------------------
##               NORMALNA - ENAKA PORAZDELITEV MARKERJEV                             --
##----------------------------------------------------------------


## TESTI ZA NORMALNE PODATKE
mu1<-0; mu2<-0.5; ro<-0.4; b1<-6; b2<-2
...
# Podatki pod H0
mu1 <- 0; mu2 <-0.5; ro <-0.4; b1 <- 3; b2 <- 3
...
##---------------------------------------------------------------
##          Moč testa  NORMAL - enaki porazdelitvi             --
##---------------------------------------------------------------
...
dump(c("podatki","test1","test2","test3","test4",
       "velikosti","moci"), "rezultati_skoraj_enaka_porazdelitev.R")
